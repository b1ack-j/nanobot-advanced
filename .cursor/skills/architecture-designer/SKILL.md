...
If updating an existing document (loop-back or new pass):
- Increment the revision number in the header
- Update content in place (do not create a new file with a version suffix)
- Return a **change summary** (1-3 sentences) to the orchestrator for CHANGELOG.md
...
- **data-models.md**: DB schemas, entity definitions, migration SQL
